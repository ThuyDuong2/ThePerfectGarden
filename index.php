...
<head>
    ...
    <title>The Perfect Garden - Home</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">The Perfect Garden</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>By
                            <strong>Thuy Duong</strong>
                        </small>
                    </h2>
                </div>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">THE VALUE OF
                        <strong>CREATING BEAUTIFUL GARDEN</strong>
                    </h2>
                    <hr>
                    <p>Beautiful gardens appeal to our senses. The colours and immense diversity of design combinations, fragrance,
                    flaccours, sounds from birds and insects attracted to the plants and variety of textures.
                  the green color of any plants give us vitality. We feel relax and refesh of our environment.
                   We love to spend time with our nature, so do not hesitate to turn your surrounding to beautiful,
                   relaxing, and refeshing area.</p>
