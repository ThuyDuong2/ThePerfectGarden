            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Contact
                        <strong>The Perfect Garden</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-8">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24974.333653858946!2d-121.45836791429046!3d38.515514525345615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x809ac550ccea659f%3A0x65e11f1ed6d38285!2sSacramento%2C%20CA%2095824!5e0!3m2!1sen!2sus!4v1670051376266!5m2!1sen!2sus"

                    width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="col-md-4">
                    <p>Phone:
                        <strong>916.812.5912</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:info@theperfectgarden.com">info@theperfectgardencom</a></strong>
                    </p>
                    <p>Address:
                        <strong>7770 Drive way
                            <br>Sacramento, CA 95824</strong>
                    </p>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                <button type="submit"  id="contact" class="btn btn-default btn-info">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
